...
> The latest release of Orion-LD is [1.11.0](https://github.com/FIWARE/context.Orion-LD/releases/tag/1.11.0) from December 2025
...
If you want to use a more stable image, the latest release (as of December 2025) is
[1.11.0](https://github.com/FIWARE/context.Orion-LD/releases/tag/1.11.0)

```console
docker run quay.io/fiware/orion-ld:1.11.0
```
