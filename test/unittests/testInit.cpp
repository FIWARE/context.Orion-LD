...
static bool equalContextAttribute(ContextAttribute* caExpected, ContextAttribute* caArg)
{
  ...
  KT_V("caArg '%s', '%s', '%s'", caArg->name.c_str(), caArg->type.c_str(), caArg->getValue().c_str());
  KT_V("caExpected '%s', '%s', '%s'",
...
static bool equalContextAttributeVector(ContextAttributeVector caExpectedV, ContextAttributeVector caArgV)
{
  ...
  {
    KT_V("different sizes: expected %d, actual %d", caExpectedV.size(), caArgV.size());
    return false;
  }
  ...
  for (unsigned int ix = 0; ix < caArgV.size(); ++ix)
  {
    ...
    for (unsigned int jx = 0; jx < caExpectedV.size(); ++jx)
    {
      ...
      {
        KT_V("attribute matches in ContextAttributeVector comparison, check next one...");
        attributeMatch = true;
        break; /* loop in jx */
      }
    }
    ...
    if (!attributeMatch)
    {
      KT_V("after looking everyone, attribute doesn't match in ContextAttributeVector comparison");
      return false;
    }
  }

  KT_V("ContextAttributeVector comparison ok");
  return true;
}
...
)
{
  ...
  {
    KT_V("different sizes: expected %d, actual %d", cerExpectedV.size(), cerArgV.size());
    return false;
  }
  ...
  for (unsigned int ix = 0; ix < cerArgV.size(); ++ix)
  {
    ...
    for (unsigned int jx = 0; jx < cerExpectedV.size(); ++jx)
    {
      ...
      {
        KT_V("entity doesn't match in ContextElementResponseVector comparison, continue ...");
        continue; /* loop in jx */
      }
      ...
      {
        KT_V("entity (without attributes) matches in ContextElementResponseVector comparison, check next one...");
        entityMatch = true;
        break; /* loop in jx */
      }
      ...
      {
        KT_V("entity (with attributes) matches in ContextElementResponseVector comparison, check next one...");
        entityMatch = true;
        break; /* loop in jx */
      }
    }
    ...
    if (!entityMatch)
    {
      KT_V("after checking everything, entity doesn't match in ContextElementResponseVector comparison");
      return false;
    }
  }

  KT_V("ContextElementResponseVector comparison ok");
  return true;
}
...
)
{
  ...
  {
    KT_V("different sizes: expected %d, actual %d", craExpectedV.size(), craArgV.size());
    return false;
  }
  ...
  for (unsigned int ix = 0; ix < craArgV.size(); ++ix)
  {
    ...
    for (unsigned int jx = 0; jx < craExpectedV.size(); ++jx)
    {
      ...
      {
        KT_V("context registration attribute matches in ContextRegistrationAttributeVector comparison, check next");
    ...
    {
      KT_V("post-lookup: context registration attribute doesn't match ContextRegistrationAttributeVector comparison");
      return false;
    }
  }

  KT_V("ContextRegistrationAttributeVector comparison ok");
  return true;
}
...
static bool equalEntityIdVector(EntityIdVector enExpectedV, EntityIdVector enArgV)
{
  ...
  {
    KT_V("different sizes: expected %d, actual %d", enExpectedV.size(), enArgV.size());
    return false;
  }
  ...
  for (unsigned int ix = 0; ix < enArgV.size(); ++ix)
  {
    ...
    for (unsigned int jx = 0; jx < enExpectedV.size(); ++jx)
    {
      ...
      {
        KT_V("entity matches in EntityIdVector comparison, check next one...");
        entityMatch = true;
        break; /* loop in jx */
      }
    }
    ...
    if (!entityMatch)
    {
      KT_V("after looking everyone, entity doesn't match in EntityIdVector");
      return false;
    }
  }

  KT_V("EntityIdVector comparison ok");
  return true;
}
...
)
{
  ...
  {
    KT_V("different sizes: expected %d, actual %d", crrExpectedV.size(), crrArgV.size());
    return false;
  }
  ...
  for (unsigned int ix = 0; ix < crrArgV.size(); ++ix)
  {
    ...
    for (unsigned int jx = 0; jx < crrExpectedV.size(); ++jx)
    {
      ...
      {
        KT_V("entity vector doesn't match in ContextRegistrationResponseVector comparison, continue...");
        continue; /* loop in jx */
      }
      ...
      {
        KT_V("context registration attribute vector doesn't match in ContextRegistrationResponseVector comparison");
        continue; /* loop in jx */
      }
      ...
      if (crExpected.providingApplication.get() == crArg.providingApplication.get())
      {
        ...
        KT_V("context registration match in ContextRegistrationResponseVector comparison, check next one...");
        break; /* loop in jx */
      }
    }
    ...
    {
      KT_V("after looking everyone, context registration doesn't matches in ContextElementResponseVector comparison");
      return false;
    }
  }
