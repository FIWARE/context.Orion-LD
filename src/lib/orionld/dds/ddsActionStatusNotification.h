#ifndef SRC_LIB_ORIONLD_DDS_DDSACTIONSTATUSNOTIFICATION_H_
#define SRC_LIB_ORIONLD_DDS_DDSACTIONSTATUSNOTIFICATION_H_
...
#endif  // SRC_LIB_ORIONLD_DDS_DDSACTIONSTATUSNOTIFICATION_H_
