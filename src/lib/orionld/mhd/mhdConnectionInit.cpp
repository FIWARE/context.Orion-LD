...
static MHD_Result orionldHttpHeaderReceive(void* cbDataP, MHD_ValueKind kind, const char* key, const char* value)
{
  ...
  else if (strcasecmp(key, "NGSILD-Correlator")  == 0) orionldState.correlator          = (char*) value;
  else if ((strcasecmp(key, "Fiware-Correlator") == 0) && ((orionldState.correlator == NULL) || (orionldState.correlator[0] == 0))) orionldState.correlator = (char*) value;
