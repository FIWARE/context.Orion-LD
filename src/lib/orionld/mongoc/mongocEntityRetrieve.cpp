...
//
// 1. Remove 'createdAt' and 'modifiedAt' if options=sysAttrs is not set
//
...
)
{
  ...
  // From the documentation of mongoc:
  //
  // http://mongoc.org/libmongoc/current/mongoc_cursor_next.html:
  //
  // Lifecycle
  //   The bson objects set in this function are ephemeral and good until the next call.
  //   This means that you must copy the returned bson if you wish to retain it beyond the
  //   lifetime of a single call to mongoc_cursor_next().
  //
