...
#define ORIONLD_URIPARAM_GEOPROPERTIES        (UINT64_C(1) << 31)
...
#define ORIONLD_URIPARAM_ENTITYMAP            (UINT64_C(1) << 38)
#define ORIONLD_URIPARAM_FORMAT               (UINT64_C(1) << 39)
#define ORIONLD_URIPARAM_EXPAND_VALUES        (UINT64_C(1) << 40)
#define ORIONLD_URIPARAM_KIND                 (UINT64_C(1) << 41)
#define ORIONLD_URIPARAM_ORDERBY              (UINT64_C(1) << 42)
...
#define ORIONLD_URIPARAM_SPLITENTITIES        (UINT64_C(1) << 52)
