...
bool entityIdCheck(KjNode* entityIdNodeP, bool duplicatedId, KjNode* errorsArrayP)
{
  ...
  {
    KT_W("Bad Input (CREATE/UPSERT: mandatory field missing: entity::id)");
  ...
  {
    KT_W("Bad Input (CREATE/UPSERT: entity::id not a string)");
  ...
  {
    KT_W("Bad Input (CREATE/UPSERT: entity::id is a string but not a valid URI)");
  ...
  {
    KT_W("Bad Input (CREATE/UPSERT: Duplicated entity::id)");
