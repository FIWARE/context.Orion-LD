...
{
  KT_T(KtLegacy, "Got a contextRegistrationResponse");
...
{
  KT_T(KtLegacy, "Got an entityId.Id: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got an entityId.Type: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "got an attribute");
...
{
  KT_T(KtLegacy, "got an attributeName: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "got an attributeType: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "got an attributeIsDomain: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got an attributeMetadata: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got an attributeMetadataName: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got an attributeMetadataType: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got an attributeMetadataValue: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got a registrationMetadata: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got a registrationMetadataName: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got a registrationMetadataType: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got a registrationMetadataValue: '%s'", value.c_str());
...
{
  KT_T(KtLegacy, "Got a providingApplication: '%s'", value.c_str());
