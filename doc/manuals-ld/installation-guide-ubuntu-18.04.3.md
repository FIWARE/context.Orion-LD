...
* khash:               0.8
* Paho MQTT            1.3.1
* Fast-DDS             3.3.0 (optional, for DDS support)
...
#### Dependencies
```bash
sudo apt-get install -y libtinyxml2-dev libboost-all-dev libyaml-cpp-dev libasio-dev
```
...
#### FIWARE DDS Enabler
```bash
sudo apt-get install -y liblz4-dev libzstd-dev libjsoncpp-dev
