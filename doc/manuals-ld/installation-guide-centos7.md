...
#### Dependencies
```bash
sudo yum -y install tinyxml2-devel boost-devel yaml-cpp-devel
# For asio-devel, you may need to download an RPM:
...
sudo rpm -i asio-devel-1.30.2-1.3.i586.rpm
```
...
#### FIWARE DDS Enabler
```bash
sudo yum -y install lz4-devel libzstd-devel json-devel
